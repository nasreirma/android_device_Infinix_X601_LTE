...
BOARD_HARDWARE_CLASS += device/Infinix/X601_LTE/cmhw
...
#TARGET_KERNEL_CONFIG := X601_LTE_defconfig
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board X601_LTE
...
# Assert
TARGET_OTA_ASSERT_DEVICE := X601_LTE,Infinix,X601-LTE
...
# RIL
BOARD_RIL_CLASS := ../../../device/Infinix/X601_LTE/ril
